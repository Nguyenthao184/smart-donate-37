...
export default function RegisterOrgModal({ onClose }) {
  ...
  function handleFile(files) {
    const f = files[0];
    if (!f) return;
    if (f.size > 10 * 1024 * 1024) { setError("File không được vượt quá 10MB"); return; }
    setFile(f);
    setError("");
  }

  async function handleSubmit() {
    if (!form.ten_to_chuc || !form.ma_so_thue || !form.nguoi_dai_dien || !form.loai_hinh) {
  ...
  return (
    <div className="rom-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="rom-modal">
        ...
        <div className="rom-modal__header">
          <div className="rom-modal__header-left">
            ...
            <div>
              <div className="rom-modal__header-title">Đăng ký tổ chức từ thiện</div>
              <div className="rom-modal__header-sub">Hoàn tất hồ sơ để được xác minh</div>
            </div>
          </div>
        ...
        <div className="rom-modal__body">
          ...
          <div className="rom-steps">
            ...
            <div className={`rom-steps__item${form.loai_hinh ? " rom-steps__item--active" : ""}`}>
              <span>2</span> Thông tin
            </div>
            <div className="rom-steps__line" />
            <div className={`rom-steps__item${file ? " rom-steps__item--active" : ""}`}>
              <span>3</span> Hồ sơ
            </div>
          </div>
          ...
          <div className="rom-section">
            <div className="rom-section__title">
              <div className="rom-section__title-bar" style={{ background: "#1890ff" }} />
              LOẠI HÌNH TỔ CHỨC
            ...
            <div className="rom-type-grid">
              {LOAI_HINH_OPTIONS.map(opt => (
                ...
                >
                  <div className="rom-type-card__icon" style={{ background: `${opt.color}15`, color: opt.color }}>
                    {opt.icon}
                  </div>
                  ...
                  {form.loai_hinh === opt.value && (
                    <div className="rom-type-card__check" style={{ background: opt.color }}>
          ...
          <div className="rom-section">
            ...
            {!file ? (
              ...
              >
                ...
                <div className="rom-upload__text">Kéo thả hoặc nhấn để tải lên</div>
                <div className="rom-upload__hint">PDF, JPG, PNG — Tối đa 10MB</div>
              </div>
            ) : (
              <div className="rom-file">
                ...
                <div className="rom-file__info">
                  ...
                  <div className="rom-file__size">{(file.size / 1024).toFixed(0)} KB</div>
                </div>
                <button
                  type="button"
            ...
            <div className="rom-upload__info">
              <div className="rom-upload__info-item">
                <FiCheck size={12} color="#52c41a" /> Giấy phép thành lập hoặc hoạt động
              </div>
              <div className="rom-upload__info-item">
                <FiCheck size={12} color="#52c41a" /> Quyết định của cơ quan có thẩm quyền
              </div>
            </div>
          </div>
